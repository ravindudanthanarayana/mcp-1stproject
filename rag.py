...
class RAGWorkflow(Workflow):
    def __init__(self, model_name="llama3.2:3b-instruct-fp16", embedding_model="BAAI/bge-small-en-v1.5"):
        super().__init__()
...
async def main():
    ...
    result = await workflow.query("Which programming language is most commonly used for building AI and machine learning applications?")
